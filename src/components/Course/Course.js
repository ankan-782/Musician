    ...
    return (
        <div className="col">
            <div className="card text-dark h-100 all-courses p-3">
                ...
                <div className="teacher-bg px-2 py-3">
                    <div className="d-flex justify-content-between align-items-center">
                        <h4 className="text-center ps-2">{name}</h4>
                        <div className="text-center">
                            <img src={img} className="teacher-img-course" alt="..." />
                ...
                <p className="card-title text-center mt-4">Course Fee: <span className="ms-2 fee fs-2 fw-bold">{price}$</span></p>
